import * as newCallAction from '../actions/new-call.actions';
...
@Injectable()
export class NewCallEffects {
  @Effect()
  loading$: Observable<Action> = this
    .actions$
    .pipe(ofType<newCallAction.Loading>(newCallAction.MapActionTypes.LOADING),

...
import { MapResult } from '../core/models/mapResult';
import { MapMakerInfo } from '../core/models/mapMakerInfo';
...
export class MapProvider {
    ...
    public getMapData(): Observable<MapResult> {
        return this.http.get<MapResult>(environment.baseApiUrl + environment.resgridApiUrl + '/BigBoard/GetMap').pipe(map((item) => {

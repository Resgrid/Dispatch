...
const MappedHeading = memo(
  forwardRef<React.ComponentRef<typeof H1Base>, IHeadingProps>(function MappedHeading({ size, className, isTruncated, bold, underline, strikeThrough, sub, italic, highlight, ...props }, ref) {
    switch (size) {
      case '5xl':
      case '4xl':
      case '3xl':
...
const Heading = memo(
  forwardRef<React.ComponentRef<typeof H1Base>, IHeadingProps>(function Heading({ className, size = 'lg', as: AsComp, ...props }, ref) {
